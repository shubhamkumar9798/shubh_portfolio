...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen w-full flex items-center justify-center text-center px-[15px] py-[20px] bg-gradient-to-b from-gray-900 via-gray-800 to-gray-700 transition-colors duration-500 overflow-hidden">
      ...
      <div className="absolute top-[20px] left-[15px] z-20 flex flex-col gap-3">
        <Popover>
          <PopoverTrigger asChild>
            <Button className="bg-amber-600 hover:bg-amber-500 text-white transition-colors shadow-lg shadow-amber-500/30">
              <Mail className="mr-2 h-4 w-4" /> Contact Me
            </Button>
          </PopoverTrigger>
          <PopoverContent className="w-[400px] sm:w-[450px] md:w-[500px] bg-gray-900 text-gray-100 rounded-xl shadow-lg p-6 max-w-[95vw]">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex flex-col space-y-2">
                ...
                <Textarea
                  ...
                  required
                  className="resize-none h-28 bg-gray-800 text-gray-100 border-gray-600"
                />
              </div>
              <Button
                type="submit"
                className="w-full bg-amber-600 hover:bg-amber-500 text-white shadow-lg shadow-amber-500/30"
              >
                Send
              </Button>
            </form>
      ...
      >
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 text-white">
          Hi, I'm{" "}
          <span className="relative inline-block px-3 py-1 bg-amber-500/20 rounded-lg text-amber-400">
            Shubham Kumar
          </span>
        </h1>
        <motion.p
